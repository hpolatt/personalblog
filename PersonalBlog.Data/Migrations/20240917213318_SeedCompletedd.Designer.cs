...
namespace PersonalBlog.Data.Migrations
{
    ...
    [Migration("20240917213318_SeedCompletedd")]
    partial class SeedCompletedd
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("PersonalBlog.Entity.Entities.Article", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("3a0532fd-df78-4cb8-983f-647498ac80f2"),
                            CategoryId = new Guid("1f1e3e0d-1d2b-4b4c-8b8a-5f5f9f5f6f6f"),
                            Content = "This is the first article content of the blog site.",
                            CreatedBy = "admin",
                            CreatedTime = new DateTime(2024, 9, 18, 0, 33, 18, 766, DateTimeKind.Local).AddTicks(5170),
                        ...
                        new
                        {
                            Id = new Guid("463b8104-3eb3-477b-92d6-c2d2737b253b"),
                            CategoryId = new Guid("d3b07384-d9a7-4f3b-8f3b-3b7b4b3b7b3b"),
                            Content = "This is the second article content of the blog site.",
                            CreatedBy = "admin",
                            CreatedTime = new DateTime(2024, 9, 18, 0, 33, 18, 766, DateTimeKind.Local).AddTicks(5190),
            ...
            modelBuilder.Entity("PersonalBlog.Entity.Entities.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = "admin",
                            CreatedTime = new DateTime(2024, 9, 18, 0, 33, 18, 766, DateTimeKind.Local).AddTicks(6000),
                            IsActive = true,
                            IsDeleted = false,
                            Name = "Software"
                        },
                        new
                        {
                            ...
                            CreatedBy = "admin",
                            CreatedTime = new DateTime(2024, 9, 18, 0, 33, 18, 766, DateTimeKind.Local).AddTicks(6010),
                            IsActive = true,
                            IsDeleted = false,
                            Name = "Hardware"
                        });
            ...
            modelBuilder.Entity("PersonalBlog.Entity.Entities.Image", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = "admin",
                            CreatedTime = new DateTime(2024, 9, 18, 0, 33, 18, 766, DateTimeKind.Local).AddTicks(6590),
